...
def _get_predictor(args) -> NNSemanticRoleLabelerPredictor:
    check_for_gpu(args.cuda_device)
    archive = load_archive(
            args.archive_file,
            cuda_device=args.cuda_device,
            )
    return NNSemanticRoleLabelerPredictor.from_archive(archive, "nn-semantic-role-labeling")


class _PredictManager:
    def __init__(
        self,
        predictor: NNSemanticRoleLabelerPredictor,
        input_sentence: str,
    ...
    def create_srl_view(
        ...
        srl_view = {"viewName": "SRL_NOM_ONTONOTES"}
        constituents = []
        relations = []
        ...
        view_data = [{"viewType": "", "viewName": "SRL_NOM_ONTONOTES", "generator": self.generator, "score": 1.0, "constituents": constituents, "relations": relations}]
