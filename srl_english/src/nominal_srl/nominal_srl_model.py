...
@Model.register("nombank-srl-bert")
class NomSrlBert(Model): # Model inherits from torch.nn.Module and Registrable
    """
    # Parameters
    ...
    def __init__(
        ...
        super(NomSrlBert, self).__init__(vocab, regularizer)
